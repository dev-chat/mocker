...
function CardTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="card-title" className={mergeClassNames('leading-none font-semibold', className)} {...props} />;
}
...
function CardAction({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={mergeClassNames('col-start-2 row-span-2 row-start-1 self-start justify-self-end', className)}
      {...props}
    />
  );
}
